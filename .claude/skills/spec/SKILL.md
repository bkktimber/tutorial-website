---
name: spec
description: Interactively build a project specification by interviewing the user about requirements, UI/UX, tech stack, and constraints
---

Your task is to first help me build a spec for my new project in $ARGUMENTS.
